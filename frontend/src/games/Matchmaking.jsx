...
const Match = () => {
    ...
    const handleStartQueue = () => {
        ...
        ws.current = new WebSocket(
            `wss://${window.location.hostname}:8000/ws/matchmaking/Pong`,
        );
        ...
        ws.current.onclose = (e) => {
            console.log("Matchmaking ws disconnected ", e);
        };
    };
        ...
        <div className="w-full h-screen flex flex-col justify-center items-center ">
            <div className="flex flex-col gap-y-3.5  backdrop-blur-sm justify-center items-center bg-gray-800 text-white rounded-lg shadow-md p-6 w-full max-w-md mx-auto border border-gray-700 h-1/4">
                ...
                <div className="flex items-center space-x-2 my-3">
                    ...
                    <span
                        className={
                            "px-2 py-1 rounded-full text-sm font-semibold bg-gray-600 text-gray-300"
                        }
                    >
                        {playerCount}
                    </span>
