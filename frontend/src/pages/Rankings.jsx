  ...
  return (
    <div className="flex items-center gap-6 mb-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <span className="block text-emerald-500 text-xs font-bold tracking-[0.2em] mb-1">
            RANKED SYSTEM
          </span>
...
const Rankings = () => {
  ...
  if (!Rankings || !Rankings.rankings) {
    //using BMO Running maybe a better idea
    return (
  ...
  const otherPlayers = Rankings.rankings.filter(
    (player) =>
      !player.is_self && !Rankings.rankings.slice(0, 3).includes(player),
  );
    ...
    <div className="flex flex-col grow lg:gap-32 gap-16">
      ...
      <div className="container md:px-16 px-0">
        <div
          ...
          className="primary-glass grow flex flex-col md:p-32 p-16 gap-16 "
        >
          <div className="flex flex-col overflow-hidden">
            ...
            <div className="bg-[url('/images/background.png')] relative flex flex-col p-32 gap-8 overflow-hidden rounded-md bg-cover bg-center bg-fixed mt-16">
              ...
              {currentUserRank && (
                <>
                  <h3 className="text-white/60 font-medium z-10">
                    Your Ranking
                  </h3>
