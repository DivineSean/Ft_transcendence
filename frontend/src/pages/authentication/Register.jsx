			...
			<div className="max-w-[1440px] m-auto lg:px-32 md:px-16 md:py-32 flex flex-col lg:gap-32 gap-16 min-h-screen">
				...
				<div className="md:px-64 px-32 flex flex-col justify-center md:gap-32 gap-24 lg:py-64 py-32 grow">
					...
					<div className="flex flex-col gap-10">
						...
						<span className="text-red text-txt-sm">{authContextData.error.lastName}</span>
						)}
					</div>
					...
					<div className="flex flex-col gap-10">
						...
						<span className="text-red text-txt-sm">{authContextData.error.email}</span>
						)}
					</div>
					...
					>
						...
						<p className="">{authContextData.providerBtnLoading ? 'loading...' : 'login with intra'}</p>
					</button>
					...
					>
						...
						<p>{authContextData.providerBtnLoading ? 'loading...' : 'login with google'}</p>
					</button>
				</div>
				</div>
			</div>
