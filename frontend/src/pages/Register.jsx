						...
						<form onSubmit={register} className="md:py-32 py-16 flex flex-col md:gap-32 gap-16">
							<div className="flex flex-col gap-10">
								<input
									...
									onBlur={handleBlur}
									className={`py-16 login-input border-b-2 grow ${error.firstName ? 'border-red' : 'border-stroke-sc'}`}
								/>
							...
							<div className="flex flex-col gap-10">
								<input
									...
									onChange={handleChange}
									onBlur={handleBlur}
									className={`py-16 login-input border-b-2 grow ${error.lastName ? 'border-red' : 'border-stroke-sc'}`}
								/>
							...
							<div className="flex flex-col gap-10">
								<input
									...
									onChange={handleChange}
									onBlur={handleBlur}
									className={`py-16 login-input border-b-2 ${error.email ? 'border-red' : 'border-stroke-sc'}`}
								/>
							...
							<div className="flex flex-col gap-10">
								<input
									...
									onChange={handleChange}
									onBlur={handleBlur}
									className={`py-16 login-input border-b-2 ${error.password ? 'border-red' : 'border-stroke-sc'}`}
								/>
							...
							<div className="flex flex-col gap-10">
								<input
									...
									onChange={handleChange}
									onBlur={handleBlur}
									className={`py-16 login-input border-b-2 ${error.confirmPassword ? 'border-red' : 'border-stroke-sc'}`}
								/>
