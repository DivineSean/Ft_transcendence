	...
	return (
		<div className="grow h-screen backdrop-blur-xl flex flex-col gap-16 items-center justify-center ralative pt-[100px]">
			...
			<div className="text-txt-md w-[50%] text-center font-light text-gray">
				...
				<span onClick={() => navigate(-1)} className="text-green font-bold hover:underline cursor-pointer"> previous</span> or <Link className="text-green font-bold hover:underline" to="/home">home</Link> page
			</div>
		</div>
	)
}
