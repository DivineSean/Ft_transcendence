		...
		<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px]">
		  <div className="secondary-glass p-32 flex flex-col items-center gap-24 z-[10]">
			<div className="flex flex-col gap-16 w-full items-center">
			  ...
			  <p className="text-txt-md text-gray lowercase text-center w-[85%] tracking-wider">{approval.message}
				<span className="font-bold text-white"> {contextData.userInfo.username} </span>
				agin
			</p>
			</div>
