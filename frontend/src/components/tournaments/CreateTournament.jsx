...
const CreateTournament = ({ setDisplayCreateTournament }) => {
	...
	return (
		<div
			className="absolute top-0 left-0 h-full w-full z-[100] flex justify-center items-center"
		>
				<div
				...
				>
					<div className="flex justify-between">
						<h1 className="text-center font-bold tracking-wider text-h-sm-md">create new tournament</h1>
						<RxCross2
							onClick={() => setDisplayCreateTournament(false)}
