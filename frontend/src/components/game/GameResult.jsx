...
const GameResult = ({ playersData, isWon }) => {
  ...
  const me = userContextData.userInfo.username !== playersData[0].user.username ? 1 : 0;
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-b from-black to-gray-900 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative w-full max-w-xl mx-4 z-10">
        <div className={`flex flex-col items-center transform ${isWon ? 'scale-100' : 'scale-95'} transition-all duration-500`}>
          ...
          <div className={`w-full mt-8 rounded-xl p-6 backdrop-blur-md ${
            isWon 
            ...
            <div className="flex items-center gap-6">
              <div className="relative">
                <div className={`w-20 h-20 rounded-full overflow-hidden border-2 ${
                  ...
                  <img
                    src={playersData[me].user.profile_image 
              ...
              <div className="flex-1">
                ...
                {(ratingChangeW > 0 || ratingChangeL > 0) && (
                  <div className={`flex items-center gap-1 mt-1 ${
                    ...
                    {isWon ? <TrendingUp size={16} /> : <TrendingDown size={16} />}
