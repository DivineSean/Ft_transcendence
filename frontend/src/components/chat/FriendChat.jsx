  ...
  return (
    ...
    >
        <div className="relative">
          ...
          <div className={`w-56 h-56 rounded-full flex border-2 ${friendInfo.isOnline && !friendInfo.isBlocked ? 'border-green' : 'border-stroke-sc'} overflow-hidden`}>
            <img
              src={
		  ...
		  {!friendInfo.isBlocked && 
          	<div className={`absolute w-16 h-16 ${friendInfo.isOnline ? 'bg-green' : 'bg-black border-[3px] border-stroke-sc'} rounded-full right-0 bottom-0`}></div>
		  }
        </div>
