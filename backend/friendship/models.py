...
class FriendshipRequest(models.Model):
    ...
    FriendshipRequestID = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True) 
    fromUser = models.ForeignKey(Users, related_name="fromUser", on_delete=models.CASCADE) #t9der t accessi via user_object.friendship_request_sent.all()
    toUser = models.ForeignKey(Users, related_name="toUser", on_delete=models.CASCADE) #t9der t accessi via user_object.friendship_request_received.all()
...
class Friendship(models.Model):
    ...
    friendshipID = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False, unique=True) 
